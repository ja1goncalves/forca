...
$c_LIndex$.prototype = new $h_O();
$c_LIndex$.prototype.constructor = $c_LIndex$;
/** @constructor */
function $h_LIndex$() {
  /*<skip>*/
}
...
$c_LIndex$.prototype.apostarLetra__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(letra, letras) {
  if ((this.tentativas$1 < this.chances$1)) {
    ...
    if ($f_sc_LinearSeqOptimized__contains__O__Z(this$18, _letra)) {
      ...
      new $c_sci_$colon$colon().init___O__sci_List(_letra, this$19);
      var x$1 = this.letras$undtentadas$1;
      ...
      this.letrasAcertadas__Lorg_scalajs_dom_raw_HTMLDivElement__V(letras)
    };
...
$c_LIndex$.prototype.letrasAcertadas__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(div_letras) {
  var elem$1 = null;
  elem$1 = "";
  if (this.letras$undtentadas$1.isEmpty__Z()) {
    var thiz = this.palavra$unddesafio$1;
    var end = (((-1) + $uI(thiz.length)) | 0);
    var isEmpty$4 = (end < 0);
    if ((!isEmpty$4)) {
      var i = 0;
      while (true) {
        var v1 = i;
        elem$1 = ($as_T(elem$1) + " _");
        if ((i === end)) {
          break
        };
        i = ((1 + i) | 0)
    ...
    var thiz$1 = this.palavra$unddesafio$1;
    var s = $as_jl_CharSequence(this.letras$undtentadas$1.head__O());
    var str = $objectToString(s);
    if (($uI(thiz$1.indexOf(str)) !== (-1))) {
      var thiz$2 = this.palavra$unddesafio$1;
      var end$1 = (((-1) + $uI(thiz$2.length)) | 0);
      var isEmpty$4$1 = (end$1 < 0);
      if ((!isEmpty$4$1)) {
        var i$1 = 0;
        while (true) {
          var v1$1 = i$1;
          var thiz$3 = $m_LIndex$().palavra$unddesafio$1;
          var c = (65535 & $uI(thiz$3.charCodeAt(v1$1)));
          if (($as_T($g.String.fromCharCode(c)) === $m_LIndex$().letras$undtentadas$1.head__O())) {
            var jsx$1 = $as_T(elem$1);
            var thiz$4 = $m_LIndex$().palavra$unddesafio$1;
            var c$1 = (65535 & $uI(thiz$4.charCodeAt(v1$1)));
            var x = $as_T($g.String.fromCharCode(c$1));
            var this$30 = new $c_sci_StringOps().init___T(x);
            var bf = $m_s_Predef$().StringCanBuildFrom$2;
            var b = $f_sc_TraversableLike__builder$1__psc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$30, bf);
            var i$2 = 0;
            var $$this = this$30.repr$1;
            var len = $uI($$this.length);
            while ((i$2 < len)) {
              var arg1 = this$30.apply__I__O(i$2);
              if ((arg1 === null)) {
                var x$1 = 0
              } else {
                var this$34 = $as_jl_Character(arg1);
                var x$1 = this$34.value$1
              };
              var c$2 = $m_jl_Character$().toUpperCase__C__C(x$1);
              b.$$plus$eq__O__scm_Builder(new $c_jl_Character().init___C(c$2));
              i$2 = ((1 + i$2) | 0)
            };
            elem$1 = ((jsx$1 + " ") + b.result__O())
          } else {
            elem$1 = ($as_T(elem$1) + " _")
          };
          if ((i$1 === end$1)) {
...
var $d_LIndex$ = new $TypeData().initClass({
  LIndex$: 0
}, false, "Index$", {
  LIndex$: 1,
  O: 1
});
$c_LIndex$.prototype.$classData = $d_LIndex$;
var $n_LIndex$ = (void 0);
function $m_LIndex$() {
  if ((!$n_LIndex$)) {
    $n_LIndex$ = new $c_LIndex$().init___()
  };
  return $n_LIndex$
}
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.desistirDoJogo = (function(arg$1, arg$2, arg$3, arg$4) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  var prep3 = arg$4;
  $m_LIndex$().desistirDoJogo__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLDivElement__V(prep0, prep1, prep2, prep3)
});
$e.apostarLetra = (function(arg$1, arg$2) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  $m_LIndex$().apostarLetra__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLDivElement__V(prep0, prep1)
});
$e.desafiar = (function(arg$1, arg$2, arg$3, arg$4, arg$5, arg$6) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  var prep3 = arg$4;
  var prep4 = arg$5;
  var prep5 = arg$6;
  $m_LIndex$().desafiar__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLElement__V(prep0, prep1, prep2, prep3, prep4, prep5)
});
$m_LIndex$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=forca-fastopt.js.map
